...
2. Actualizar el default de `relayBaseUrl` en
   `app/src/main/java/com/vektorgo/app/ui/components/MercadoPagoOAuthDialog.kt`
   con tu `project-ref` real (ya dejé el placeholder
   `REEMPLAZAR-project-ref` marcado en el código).
